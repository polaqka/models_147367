...
NITER = 150 #1500
dt = 0.001
tpnt = numpy.arange(0.0, 40 + dt, dt)

mean_open_time = numpy.zeros([ca_concs.size, ip_concs.size, 2])

print('Simulating mean open time for IP3R model (Doi et al. 2005)...')
...
numpy.savetxt('results/ip3r_doi_mean_open_time.dat', res_reshaped)
numpy.savetxt('results/ip3r_doi_open_times.dat', all_open_times)