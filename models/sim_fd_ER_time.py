...
dt = 10
tpnt = numpy.arange(0.0, 20000+dt, dt)
...
numpy.savetxt('results/ip3r_fd_results_ER_receptors_10.dat', res)
numpy.savetxt('results/ip3r_fd_ca_concs_ER_receptors_10.dat', ca_concs)

print('sim_fd_ER_time done')
